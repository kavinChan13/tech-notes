...
[![Docs](https://img.shields.io/badge/Docs-70_HTML-1c3a5e?style=for-the-badge)](https://kavinchan13.github.io/tech-notes/)
...
无需下载，浏览器直接打开即可阅读全部 37 篇技术与管理指南 + 12 份 EM 模板 + 8 份 PM 双线指南 + 12 份 PM 双线模板
...
- **PM 双线**：项目经理（PgM）+ 产品经理（PdM）8 份指南：能力雷达、EVM 计划、A/B 测试、干系人影响力、JTBD Discovery、PRD 写作、PMBOK 全景、面试速查
...
| [协程完全深度](https://kavinchan13.github.io/tech-notes/cpp_coroutines_deep_dive.html) | promise_type / awaiter 三件套、手写 Task & Generator、Symmetric Transfer、HALO、调度器对接、调试与泄漏排查 |
...
| [CMake & CI](https://kavinchan13.github.io/tech-notes/cpp_cmake_ci_guide.html) | 现代 CMake 写法 + GitLab/GitHub Actions CI 实战 + Bazel/Ninja/Modules 构建系统全景 |
| [ABI 兼容性深度](https://kavinchan13.github.io/tech-notes/cpp_abi_compatibility_guide.html) | Itanium ABI / libstdc++ Dual ABI / inline namespace / PIMPL / 跨 .so 边界 / 真实生产事故 |
| [安全与硬化深度](https://kavinchan13.github.io/tech-notes/cpp_security_hardening_guide.html) | 5 大漏洞分类 / FORTIFY_SOURCE / Stack Protector / RELRO / CFI / 静态分析 / MISRA / AUTOSAR / SBOM |
| [可观测性深度](https://kavinchan13.github.io/tech-notes/cpp_observability_guide.html) | 结构化日志 (spdlog/glog) / Prometheus + HDR Histogram / Distributed Tracing (OpenTelemetry C++) / Continuous Profiling / eBPF / SLI-SLO-Error Budget |
...
| [网络编程](https://kavinchan13.github.io/tech-notes/cpp_networking_guide.html) | socket、epoll、TCP 状态机、Reactor、HTTP/2 + QUIC/HTTP3/BBR/SO_REUSEPORT |
| [异步网络框架深度](https://kavinchan13.github.io/tech-notes/cpp_async_networking_guide.html) | Boost.Asio + 协程 / Reactor vs Proactor vs Sender-Receiver / gRPC / brpc / QUIC / 百万连接架构 |
...
### VIII · PM 双线（项目经理 × 产品经理）

> 给"已经做过 IC / Tech Lead / EM，想横向打开 Project Manager / Product Manager 能力面"的 3 个月体系性补齐地图。重点补三大弱项：① 项目计划/EVM ② 数据/AB 测试 ③ 干系人/影响力。

| 文档 | 主题 |
|---|---|
| **[PM 双线总览](https://kavinchan13.github.io/tech-notes/pm_dual_track_overview.html)** | **PgM × PdM 能力雷达 + 知识地图 + 12 周路线 + 8 份配套文档导航（入口）** |
| [项目计划与 EVM 完全指南](https://kavinchan13.github.io/tech-notes/pm_evm_planning_guide.html) | WBS / CPM / PERT / EVM 7 公式 / 资源平衡 / 关键链 + 25 道计算题 |
| [数据分析与 A/B 测试](https://kavinchan13.github.io/tech-notes/pm_data_ab_testing.html) | NSM / AARRR / HEART · 漏斗 / Cohort / 留存 · A/B 设计 + 8 大陷阱 · SQL 8 招 |
| [干系人与影响力指南](https://kavinchan13.github.io/tech-notes/pm_stakeholder_influence.html) | 权力-利益方格 · RACI/DACI/RAPID · Cohen-Bradford 6 类货币 · Harvard 谈判 7 要素 |
| [产品发现与 JTBD](https://kavinchan13.github.io/tech-notes/pdm_discovery_jtbd.html) | 双钻 / JTBD / Opportunity Solution Tree / 用户访谈 / Persona / 旅程图 |
| [PRD 写作工具包](https://kavinchan13.github.io/tech-notes/pdm_prd_writing_kit.html) | PRD/MRD/BRD 区别 + 5 段式 PRD 模板 + INVEST + Given-When-Then + 12 项评审清单 |
| [PMBOK 全景速查](https://kavinchan13.github.io/tech-notes/pgm_pmbok_overview.html) | 5 大过程组 × 10 大知识领域 49 过程矩阵 + PMBOK 6 vs 7 + EM 视角解读 |
| [PM 面试速查卡](https://kavinchan13.github.io/tech-notes/pm_interview_cards.html) | PgM/PdM 行为 / Case / Estimation 90 题速查，含 STAR 模板 + 7 大致命红旗 |
| **[PM Templates · Library](https://kavinchan13.github.io/tech-notes/pm-templates/)** | **12 份必备模板：Charter / Stakeholder / WBS / RACI / RAID / CR / EVM / JTBD / Interview / Persona / PRD / A/B（沿用 EM Templates paper 风）** |
