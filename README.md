...
[![Docs](https://img.shields.io/badge/Docs-54_HTML-1c3a5e?style=for-the-badge)](https://kavinchan13.github.io/tech-notes/)
[![Cards](https://img.shields.io/badge/Interview_Cards-478-c084fc?style=for-the-badge)](https://kavinchan13.github.io/tech-notes/interview/)
...
无需下载，浏览器直接打开即可阅读全部 **54 篇技术与管理指南 + 478 张面试卡片 + 24 份模板**
...
- **A · 架构师方法论** — 软件架构（C4/DDD/ADR）、大型 C++ 工程化、分布式系统、存储与数据架构、可观测性工程、Capstone
...
├── architect/              # A01..A06  架构师方法论 (6 docs)
...
├── interview/              # I01..I05  面试 — 1 篇长文 + 4 套交互式卡片应用 (478 题)
│
├── assets/                 # 共享样式资源
├── tools/                  # 维护脚本
