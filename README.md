...
<img src="./assets/readme-hero.svg" alt="Kavin Tech Notes · 计算机科学知识库" width="100%">
...
<img src="./assets/readme-directory-preview.svg" alt="README 目录预览" width="100%">

> 该预览图已对齐主页的信息层级：领域聚合、简洁摘要、统一视觉语言。
